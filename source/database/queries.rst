...
it into your database. Higgs has three methods that help you do
this:
...
.. note:: Since v7.3.0, the ``close()`` method deallocates the prepared statement in all DBMS. Previously, they were not deallocated in Postgre, SQLSRV and OCI8.
...
``Higgs\Database\Query``. This class is responsible for binding
