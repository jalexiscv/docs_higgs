...
To get the most out of Higgs, you need to understand how the application is structured, by default, and what you
...
.. note:: If you install Higgs with Composer, the ``system`` is located in ``vendor/Higgs(AI)/framework/system``.
...
All files in this directory live under the ``Higgs`` namespace.
