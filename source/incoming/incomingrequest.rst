...
``Higgs\Controller`` and can be accessed as a class property:
...
Since v7.3.0, you can use the ``is()`` method. It returns boolean.
...
With Higgs's built-in methods you can simply do this:
...
.. note:: The ``getRoutePath()`` method can be used since v7.4.0. Prior to v7.4.0,
...
``Higgs\HTTP\Files\UploadedFile`` instance. This helps to ease the pain of working with uploaded files,
...
* :meth:`Higgs\\HTTP\\Request::getIPAddress`
* :meth:`Higgs\\HTTP\\Request::isValidIP`
* :meth:`Higgs\\HTTP\\Request::getMethod`
* :meth:`Higgs\\HTTP\\Request::setMethod`
* :meth:`Higgs\\HTTP\\Request::getServer`
* :meth:`Higgs\\HTTP\\Request::getEnv`
* :meth:`Higgs\\HTTP\\Request::setGlobal`
* :meth:`Higgs\\HTTP\\Request::fetchGlobal`
* :meth:`Higgs\\HTTP\\Message::getBody`
* :meth:`Higgs\\HTTP\\Message::setBody`
* :meth:`Higgs\\HTTP\\Message::appendBody`
* :meth:`Higgs\\HTTP\\Message::populateHeaders`
* :meth:`Higgs\\HTTP\\Message::headers`
* :meth:`Higgs\\HTTP\\Message::header`
* :meth:`Higgs\\HTTP\\Message::hasHeader`
* :meth:`Higgs\\HTTP\\Message::getHeaderLine`
* :meth:`Higgs\\HTTP\\Message::setHeader`
* :meth:`Higgs\\HTTP\\Message::removeHeader`
* :meth:`Higgs\\HTTP\\Message::appendHeader`
* :meth:`Higgs\\HTTP\\Message::prependHeader`
* :meth:`Higgs\\HTTP\\Message::getProtocolVersion`
* :meth:`Higgs\\HTTP\\Message::setProtocolVersion`
...
.. php:class:: IncomingRequest
    ...
    .. php:method:: getPath()
        ...
        .. note:: Prior to v7.4.0, this was the safest method to determine the
    ...
    .. php:method:: setPath($path)
        ...
        .. note:: Prior to v7.4.0, used mostly just for testing purposes, this
