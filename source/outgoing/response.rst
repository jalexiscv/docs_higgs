...
Many times you will not need to touch the class directly, since Higgs takes care of
...
When you need to set the output of the script directly, and not rely on Higgs to automatically get it, you
...
.. note:: Due to a bug, in v7.3.3 or previous versions, the status code of the
    actual redirect response might be changed even if a status code was specified.
    See :ref:`ChangeLog v7.3.4 <v434-redirect-status-code>`.
...
By default, all response objects sent through Higgs have HTTP caching turned off. The options and exact
...
* :meth:`Higgs\\HTTP\\Message::headerLine`
* :meth:`Higgs\\HTTP\\Message::setHeader`
* :meth:`Higgs\\HTTP\\Message::removeHeader`
* :meth:`Higgs\\HTTP\\Message::appendHeader`
* :meth:`Higgs\\HTTP\\Message::protocolVersion`
* :meth:`Higgs\\HTTP\\Message::setProtocolVersion`
* :meth:`Higgs\\HTTP\\Message::negotiateMedia`
* :meth:`Higgs\\HTTP\\Message::negotiateCharset`
* :meth:`Higgs\\HTTP\\Message::negotiateEncoding`
* :meth:`Higgs\\HTTP\\Message::negotiateLanguage`
* :meth:`Higgs\\HTTP\\Message::negotiateLanguage`
...
.. php:class:: Response
    ...
    .. php:method:: send(): Response
        ...
        this as it is handled automatically by Higgs.

    .. php:method:: setCookie($name = ''[, $value = ''[, $expire = ''[, $domain = ''[, $path = '/'[, $prefix = ''[, $secure = false[, $httponly = false[, $samesite = null]]]]]]]])

        :param array|Cookie|string $name: Cookie name *or* associative array of all of the parameters available to this method *or* an instance of ``Higgs\Cookie\Cookie``
