...
Higgs's CLI library makes creating interactive command-line scripts simple, including:
...
.. note:: Since v7.3.0, you can write tests for these methods with ``PhpStreamWrapper``.
